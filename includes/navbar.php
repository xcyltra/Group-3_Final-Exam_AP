...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="<?php echo $base_url; ?>./jobs/index.php" class="<?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">Pendaftaran</a>

        <a href="<?php echo $base_url; ?>/admin/requirments/index.php" class="<?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">Persyaratan</a>

        <a href="<?php echo $base_url; ?>./users/index.php" class="<?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">User</a>
    </div>

    <!-- LINK KANAN -->
    <div class="auth-links">
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="#" style="font-weight: bold;"><?php echo htmlspecialchars($_SESSION['full_name']); ?></a>
